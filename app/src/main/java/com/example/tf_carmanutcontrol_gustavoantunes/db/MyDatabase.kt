...
@Database(entities = [Manutencao::class], version = 1, exportSchema = true)
...
abstract class MyDatabase :
    ...
    abstract val manutencaoDAO: ManutencaoDAO // Neste aplicativo temos somente um DAO. Nada impede de termos vários DAOs e várias tabelas
